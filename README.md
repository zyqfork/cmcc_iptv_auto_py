...
- **⚙️ 路由器配置**：wan口上网用vlan就是eth1.3，新建iptv口不用vlan，设置就是eth1，iptv口为br-iptv，机顶盒桥接br-iptv网络可以正常观看
...
- 将br-iptv 接口获取到的dhcp ip最后一位改为1后加入到路由网关,183.235.0.0/16 流量会经过新设置的网关出口,从而实现自动更新访问183流量
- **注意,br-iptv 接口为dhcp模式**,防火墙参考下面设置
...
- 🖼️ Logo地址：`http://your-domain:7077/183.235.16.92:8081/pics/micro-picture/channelNew/xxx.png`
...
5. **⏪ 额外主json** http://183.235.16.92:8082/epg/api/getAllChannel.json 这个地址 包含大量地方台,但是近100个失效,暂时不采用,可以作为自定义参考
